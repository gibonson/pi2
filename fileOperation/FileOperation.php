...
class FileOperation
{
    ...
    {
        $fullPath = $mainDir . "/userServices/" . $moduleName;
    ...
    public function createBox($mainDir, $moduleName, $boxName, $boxContent): string
    {
        ...
        $boxFile = fopen($mainDir . "/userServices/" . $moduleName . "/" . $boxName, "w") or die("Unable to open file!");
    ...
    public function createScript($mainDir, $moduleName, $scriptName, $scriptContent): string
    {
        ...
        mkdir($mainDir . "/userServices/" . $moduleName . "/script/", 0777, true);
        $scriptFile = fopen($mainDir . "/userServices/" . $moduleName . "/script/" . $scriptName, "w") or die("Unable to open file!");
